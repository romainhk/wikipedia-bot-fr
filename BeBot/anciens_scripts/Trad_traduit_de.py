                    ...
                    if len(a) > 2:
                        if self.oldidRE.match(a[2]):
                            ...
                            if not date == u'':
                                ...
                                BeBot.save(p, commentaire=u'Ajout automatique du paramètre "date" au modèle "Traduit de" ([[Discussion modèle:Traduit de#Date de traduction sans oldid]])', minor=True)
